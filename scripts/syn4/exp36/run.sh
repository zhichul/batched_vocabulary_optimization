...
EXPID="36"
mkdir -p ${BLU_ARTIFACTS}/bopt/syn4/exp${EXPID}
DATA_PREFIX=${BLU_CORPORA}/vopt/syn/4/full
ARTIFACT_PREFIX=${BLU_ARTIFACTS}/bopt/syn4/exp${EXPID}
SCRIPT_PREFIX=${HOME}/jhu/bopt/scripts/syn4/exp${EXPID}
for SEED in 42
do
for LAYER in 1 2
do
...
CUDA_VISIBLE_DEVICES=0 python3 -O -um bopt.run \
    ...
    --weights_file /export/a01/artifacts/bopt/syn4/exp34-11/42/${L1}/768/checkpoint-3262/learned_vocab.txt  \
