...
CUDA_VISIBLE_DEVICES=1 python3 -O -um bopt.run \
    ...
    --eval_dataset ${DATA_PREFIX}/ptb.test.txt \
    ...
    --weights_file ${ARTIFACT_PREFIX}/${SEED}/${GL}/${SIZE}/${LR}/${L1}/checkpoint-4200/learned_vocab.txt \
    --model_name ${ARTIFACT_PREFIX}/${SEED}/${GL}/${SIZE}/${LR}/${L1}/checkpoint-4200/ \
    #--eval_viterbi_mode \
