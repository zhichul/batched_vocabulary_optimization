...
CUDA_VISIBLE_DEVICES=1 python3 -O -um bopt.run \
    ...
    --input_vocab /export/a01/artifacts/bopt/ptb/exp20/44/768/0.02/0.1/checkpoint-4400/learned_vocab.txt \
    --weights_file /export/a01/artifacts/bopt/ptb/exp20/44/768/0.02/0.1/checkpoint-4400/learned_vocab.txt \
    --output_vocab /export/a01/artifacts/bopt/ptb/exp20/44/768/0.02/0.1/checkpoint-4400/learned_vocab.txt  \
