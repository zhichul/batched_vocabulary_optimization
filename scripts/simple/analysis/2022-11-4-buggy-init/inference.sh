#!/usr/bin/env bash
#$ -wd /home/zlu39/jhu/bopt/scripts/simple/exp1-13
#$ -V
#$ -N s3e1-13
...
#$ -q g.q
exit 1 # this script is stale because the checkpoints have been moved to 768-buggy-init
...
rm ${ARTIFACT_PREFIX}/42/0.0/768/full_lattice_log.train.json
rm ${ARTIFACT_PREFIX}/42/0.0/768/full_lattice_log.valid.json
...
CUDA_VISIBLE_DEVICES=1 python3 -O -um bopt.run \
    --seed ${SEED} \
    --train_dataset ${DATA_PREFIX}/se.${DAT}.128.txt \
    --eval_dataset ${DATA_PREFIX}/se.${DAT}.128.txt \
    ...
    --log_lattice unit marginal log_prob ent \
    --log_lattice_file ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/full_lattice_log_0.${DAT}.json \
...
#    --debug_fixed_point \
#    --length_normalized_initialization \
#    --model_name ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/checkpoint-${CKPT} \
#    --log_lattice unit marginal log_prob ent \
#    --log_lattice_file ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/full_lattice_log.${DAT}.json \
#    --log_lattice_key ${CKPT}
#done
#done
#done
