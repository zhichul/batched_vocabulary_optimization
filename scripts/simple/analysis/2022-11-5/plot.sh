...
python3 ../training_curves.py \
  $BLU_ARTIFACTS/bopt/simple/exp1-13/42/0.0/768/log.json \
...
do
  cat /Users/blu/artifacts/bopt/simple/exp${EXP}/42/0.0/768/full_lattice_log.${DAT}.json | python3 ../extract_log.py marginal unit log_prob > /Users/blu/artifacts/bopt/simple/exp${EXP}/42/0.0/768/lattice.${DAT}.json
