...
CUDA_VISIBLE_DEVICES=0 python3 -O -um bopt.run \
    ...
    --output_dir ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/unigram_init/output_viterbi/1 \
    ...
    --weights_learning_rate 0.002 \
    --weights_file ${DATA_PREFIX}/unigram-weights-10000.txt \
    --normalize_by_tokens \
    --output_viterbi \
    --model_name ${ARTIFACT_PREFIX}/42/${L1}/${SIZE}/unigram_init/checkpoint-80/ \
