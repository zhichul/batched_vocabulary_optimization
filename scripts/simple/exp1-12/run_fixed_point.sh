...
CUDA_VISIBLE_DEVICES=0 python3 -O -um bopt.run \
    ...
    --debug_fixed_point \
#    --model_name ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/fixed_point/checkpoint-30 \
#    --weights_file ${ARTIFACT_PREFIX}/${SEED}/${L1}/${SIZE}/fixed_point/checkpoint-30/learned_vocab.txt
done
done
done