...
LOAD_PREFIX=${BLU_ARTIFACTS}/boptv2/superbizarre/exp1-2
...
PRETRAINED_TOKENIZER=${LOAD_PREFIX}/${SEED}/${L1}/${CKPT}/learned_vocab.txt
CONFIG_NAME=${SCRIPT_PREFIX}/config768.json

CUDA_VISIBLE_DEVICES=1 python3 -O -um bopt.train \
    ...
    \
    --input_vocab ${PRETRAINED_TOKENIZER} \
    --input_tokenizer_weights ${PRETRAINED_TOKENIZER} \
