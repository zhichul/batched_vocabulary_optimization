...
CUDA_VISIBLE_DEVICES=1 CUDA_LAUNCH_BLOCKING=1 python3 -O -um bopt.train \
    ...
    --config  ${CONFIG_NAME} \
    \
    --input_vocab  /export/a01/artifacts/boptv2/debug/exp1/42-1/768/0.1/checkpoint-early-stopping/learned_vocab.txt \
    --input_tokenizer_weights /export/a01/artifacts/boptv2/debug/exp1/42-1/768/0.1/checkpoint-early-stopping/learned_vocab.txt \
