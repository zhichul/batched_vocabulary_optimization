...
for AHEAD in 1
do
for TRAJ in 50 100 200 400 600
do
for WARMUP in 0 #0 1 3 5 7 9 10 15 20 25 30 50 100
do
for BIAS in mult_then_renorm
do
DATA_PREFIX=${BLU_CORPORA}/vopt/syn/4/${DATA}
OUTPUT_DIR=${ARTIFACT_PREFIX}/${SEED}/${SIZE}/${L1}/${DATA}/${AHEAD}/${TRAJ}/${BIAS}/${WARMUP}
