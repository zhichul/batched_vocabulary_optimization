...
OUTPUT_DIR=${ARTIFACT_PREFIX}/${SEED}/${SIZE}/${L1}/${DATA}/${AHEAD}/${TRAJ}/${BIAS}/${WARMUP}/combined/${LR}/pretrained/
...
CUDA_VISIBLE_DEVICES=0 CUDA_LAUNCH_BLOCKING=1 python3 -O -um bopt.train_bilevel \
    ...
    --config  ${CONFIG_NAME} \
    \
    --input_vocab ${BLU_ARTIFACTS}/boptv2/syn4_small/exp21-1/42/768/0.01/full/checkpoint-final/learned_vocab.txt \
    --output_vocab ${DATA_PREFIX}/output_vocab.txt \
    --input_tokenizer_weight ${BLU_ARTIFACTS}/boptv2/syn4_small/exp21-1/42/768/0.01/full/checkpoint-final/learned_vocab.txt \
    ...
    --input_tokenizer_learning_rate 0.1 \
    --train_batch_size 1024 \
    --train_steps 100 \
    --patience 10 \
    --lr_adjustment_window_size 1024 \
    --reduce_factor 0.25 \
    \
    --eval_steps 1 \
    \
    ...
    --random_restarts 5 \
    --eval_random_restarts 1 \
#    --fix_transformer_initialization \
