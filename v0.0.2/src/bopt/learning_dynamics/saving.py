...
def save_learning_dynamics_log(setup, step, weights_dynamics, attention_dynamics, conditional_marginal_dynamics, weights_grad_dynamics, attention_grad_dynamics, conditional_marginal_grad_dynamics):
    torch.save({
